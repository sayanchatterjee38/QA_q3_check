...
if __name__ == '__main__':
    ...
    config.General.workArea = 'QA_q3_cent0100_pt0p5_8p0_efffakesecmul_ptetamvacuts_noalgopara_MCDEBUGreco_Oct29_2021_0' 
    ...
    config.General.requestName = 'PbPb2018_QA_q3_cent0100_pt0p5_8p0_efffakesecmul_ptetamvacuts_noalgopara_MCDEBUGreco_Oct29_2021_0'
   ...
   # config.Data.lumiMask = '/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions18/HI/PromptReco/Cert_326381-327564_HI_PromptReco_Collisions18_JSON.txt'
    config.Data.outputDatasetTag = 'PbPb2018_QA_q3_cent0100_pt0p5_8p0_efffakesecmul_ptetamvacuts_noalgopara_MCDEBUGreco_Oct29_2021_0'
    submit(config)
